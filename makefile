...
list = lib/list/
CC = gcc
CFLAGS = -std=c11 -g -Wall -Wconversion -Werror -Wextra -Wpedantic -Wwrite-strings -O2 -I$(hashtabledir) -I$(holdalldir) -I$(read_words) -I$(mset_longint) -I$(setb) -I$(list) -DHOLDALL_INSERT_TAIL
LDFLAGS = 
VPATH = $(hashtabledir):$(holdalldir):$(read_words)
objects = $(hashtabledir)hashtable.o $(holdalldir)holdall.o $(read_words)read_words.o $(mset_longint)mset_longint.o $(setb)setb.o $(list)list.o main.o lidx.o option.o
executable = lidx
